...
class BlockChain{
  ...
  // transType: bought/sold
  addNewData(userName, indexName, text1, text2, last_sale, buyState){
        this.curr_data.push({ userName, indexName, text1, text2, last_sale, buyState });
  }
